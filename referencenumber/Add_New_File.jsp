...
function Onload()
{
	...
	for(i=0;i<val.length;i++)
	{
		if(val[i].value=="")
		{
			...
			document.NewFileCreation.val[i].value.focus();
		}
	}
	document.NewFileCreation.action="../../AssetsServlet";
	document.NewFileCreation.submit();  
}
</script>
<style>
table{
...
<% 
	...
	%>
<form name="NewFileCreation" method="post">
<input type="hidden" name="ActionId" value="CreateNewFile">
<input type="hidden" name="Task" value="Add">
<input type="hidden" name="FileCre" value="<%=email%>">
  <div class="container"> 
	<table id=Layer5  class="tbl" class="table table-striped">
		<caption>New Document Creation</caption>
		<tr>
			<td>
				<font size="2px">File Name</font>
			</td>
			<td>
		...
		<tr>
			<td>
				<font size="2px">File Short Name</font>
			</td>
			<td>
				<input type="text" class="text form-control" placeholder="Short name(Eq: WKT, MTL...)" maxlength="3" name="FileCre" onkeypress="return (event.charCode!=39)" required>
			</td>
		</tr>
		<tr>
