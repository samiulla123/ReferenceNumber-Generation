 ...
 <TABLE >
	...
	%>
		...
		<TR>
			...
			<A href="Add_New_File.jsp" target="indexCenter"
				onclick="change(this)">Create New File</A></TD>
		</TR>
 		 <tr>
			<TD nowrap height="0">&nbsp; <IMG border="0"
				src="../../images/left.gif" width="12" height="12">&nbsp;
			<A href="Gen_reference_number.jsp" target="indexCenter"
				onclick="change(this)">Generate Reference Number</A></TD>
		</tr>
		 <tr>
			<TD nowrap height="0">&nbsp; <IMG border="0"
				src="../../images/left.gif" width="12" height="12">&nbsp;
			<A href="Reference_Register.jsp" target="indexCenter"
				onclick="change(this)">Reference Report</A></TD>
		</tr>
		 <tr>
			<TD nowrap height="0">&nbsp; <IMG border="0"
				src="../../images/left.gif" width="12" height="12">&nbsp;
			<A href="Ref_No_Management.jsp" target="indexCenter"
				onclick="change(this)">Managent Ref No</A></TD>
		</tr>
		 <tr>
			<TD nowrap height="0">&nbsp; <IMG border="0"
				src="../../images/left.gif" width="12" height="12">&nbsp;
			<A href="Ref_Personal_Docs.jsp" target="indexCenter"
				onclick="change(this)">Link Personal Docs</A></TD>
		</tr>
		<tr>
			<TD nowrap height="0">&nbsp; <IMG border="0"
				src="../../images/left.gif" width="12" height="12">&nbsp;
			<A href="CourseOutlineUpload1.jsp" target="indexCenter"
				onclick="change(this)">Demo</A></TD>
		</tr>
	</TBODY>
</TABLE> 
</div>
